...
// the auth screen. Left hemisphere is a plain lobed outline with sulcus
// wrinkles (white); right hemisphere is the same lobed silhouette in blue,
// with a node/network route curving down to the pin, and a vertical stem
// connecting the crown to the pin — matching the reference brand lockup.
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        ...
        fill="#2B5CFF"
      />
      <circle cx="100" cy="115" r="12" fill="#0A0F2C" />
    </svg>
  );
}
